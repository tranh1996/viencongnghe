...
const viTranslations: Record<string, string> = {
  ...
  'visionMission.vision.title': 'Slogan',
  'visionMission.mission.title': 'Năng lực cốt lõi',
  'visionMission.values.title': 'Hướng phát triển',
  'visionMission.vision.contentNotAvailable': 'Nội dung slogan chưa có sẵn.',
  ...
  'contact.form.cooperationTitle': 'LIÊN HỆ HỢP TÁC VỚI CHÚNG TÔI',
  'contact.form.cooperationDescription': 'Viện Công Nghệ sẵn sàng phục vụ khách hàng 24/7, chỉ cần để lại thông tin liên hệ dưới đây. Chúng tôi sẽ liên hệ với bạn ngay sau ít phút.',
  'contact.form.submitButton': 'GỬI THÔNG TIN',
  'contact.sidebar.instituteName': 'VIỆN CÔNG NGHỆ',
  'contact.sidebar.instituteSubtitle': 'INSTITUTE OF TECHNOLOGY',
...
const enTranslations: Record<string, string> = {
  ...
  'visionMission.vision.title': 'Slogan',
  'visionMission.mission.title': 'Core Competencies',
  'visionMission.values.title': 'Development Direction',
  'visionMission.vision.contentNotAvailable': 'Slogan content not available.',
  ...
  'contact.info.fax': 'Fax',
  'contact.form.cooperationTitle': 'CONTACT US FOR COOPERATION',
  'contact.form.cooperationDescription': 'Institute of Technology is ready to serve customers 24/7, just leave your contact information below. We will contact you within minutes.',
  'contact.form.submitButton': 'SEND INFORMATION',
  'contact.sidebar.instituteName': 'INSTITUTE OF TECHNOLOGY',
  'contact.sidebar.instituteSubtitle': 'INSTITUTE OF TECHNOLOGY',
